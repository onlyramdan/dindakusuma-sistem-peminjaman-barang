...
import { DataTableColumnHeader } from "@/components/dashboard/rooms-loans/data-table-column-header";
import { DataTableRowActions } from "@/components/dashboard/rooms-loans/data-table-row-action";
import { RoomsLoansProps } from "@/lib/validator/dashboard/rooms-loans/api";
import { Checkbox } from "@/ui/checkbox";
import { ColumnDef } from "@tanstack/react-table";

export const columns: ColumnDef<RoomsLoansProps>[] = [
  {
    id: "select",
    header: ({ table }) => (
      <Checkbox
